...
const buttonVariants = tv({
	...
	variants: {
		variant: {
			default:
				'bg-[#3b82f6] text-white hover:bg-[#2563eb] hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(59,130,246,0.3)] hover:shadow-[0_8px_30px_rgba(59,130,246,0.5)]',
			destructive:
				'bg-red-600 text-white hover:bg-red-700 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(239,68,68,0.3)]',
			outline:
				'border border-[rgba(59,130,246,0.3)] bg-transparent text-gray-900 hover:bg-[rgba(59,130,246,0.1)] hover:border-[#3b82f6] dark:text-slate-100 dark:border-blue-400/30 dark:hover:bg-blue-400/10 dark:hover:border-blue-400',
			secondary:
...
export { Root, type Props, type Events, Root as Button, buttonVariants };
